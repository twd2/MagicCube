...
extern map<CubeRotateMethod, string> CubeRotateMethodEnumName;
extern map<string, CubeRotateMethod> NameToCubeRotateMethod;

#define FORMAT1_LENGTH (3*3*3*6) // 3*3*3 sub cubes, each sub cube has 6 surfaces
#define FORMAT2_LENGTH (3*3*6) // 6 surfaces, each surface has 3*3 blocks